                    ...
                    child: TabBar(
                      ...
                      tabs: [
                        SizedBox(
                          ...
                          child: Center(
                            child: Text(
                              translateString('Delivery to the address', 'توصيل على العنوان'),style: const TextStyle(fontSize: 13,fontWeight: FontWeight.normal),
                            ),
                          ),
                        ),
                        SizedBox(
                          ...
                          child: Center(
                            child: Text(
                              translateString('Delivery by phone', 'توصيل عبر الهاتف'),style: const TextStyle(fontSize: 13,fontWeight: FontWeight.normal),
                            ),
                          ),
                        ),
                      ],
                          ...
                          children: [
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hint: Row(
                                  children: [
                                    Text( _hint[0],style: TextStyle(
                                        color: Colors.black,
                                        fontFamily:
                                        (lang == 'en') ? 'Nunito' : 'Almarai',
                                        fontSize: w * 0.027,
                                        fontWeight: FontWeight.w500),),
                                    Text('*',style: TextStyle(color: mainColor,fontSize: w*0.07),),
                                  ],
                                ),
                              ),
                            ),
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: <Widget>[
                                                        ...
                                                        Center(child: Text(translateString('Select City', 'اختر المحافظة'),style: TextStyle(color: Colors.black,fontSize: w*0.04,fontWeight: FontWeight.normal,),)),
                                                                ...
                                                                child: InkWell(
                                                                  ...
                                                                  child: Container(
                                                                    ...
                                                                    decoration: BoxDecoration(
                                                                        ...
                                                                        border: Border.all(color: selected2 == index ? mainColor: Colors.black54)
                                                                    ),
                                                      ...
                                                      Text(
                                                        ...
                                                        style: TextStyle(
                                                          fontFamily: (lang == 'en')
                                                              ...
                                                              : 'Almarai',
                                                          color:
                                                          Colors.black,fontSize: w * 0.03,),
                                                      ),
                                                      Text('*',style: TextStyle(color: mainColor,fontSize: w*0.06),),
                                                    ],
                                                  ),
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                errorBorder: form2(),
                                focusedErrorBorder: form2(),
                                hint:Text( _hint[4],style: TextStyle(
                                    color: Colors.black,
                                    fontFamily:
                                    (lang == 'en') ? 'Nunito' : 'Almarai',
                                    fontSize: w * 0.027,
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                errorBorder: form2(),
                                focusedErrorBorder: form2(),
                                hint:Text( _hint[5],style: TextStyle(
                                    color: Colors.black,
                                    fontFamily:
                                    (lang == 'en') ? 'Nunito' : 'Almarai',
                                    fontSize: w * 0.027,
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                errorBorder: form2(),
                                focusedErrorBorder: form2(),
                                hint:Text( _hint[7],style: TextStyle(
                                    color: Colors.black,
                                    fontFamily:
                                    (lang == 'en') ? 'Nunito' : 'Almarai',
                                    fontSize: w * 0.027,
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                errorBorder: form2(),
                                focusedErrorBorder: form2(),
                                hint:Text( _hint[6],style: TextStyle(
                                    color: Colors.black,
                                    fontFamily:
                                    (lang == 'en') ? 'Nunito' : 'Almarai',
                                    fontSize: w * 0.027,
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                errorBorder: form2(),
                                focusedErrorBorder: form2(),
                                hint:  Text( _hint[9],style: TextStyle(
                                    color: Colors.black,
                                    fontFamily:
                                    (lang == 'en') ? 'Nunito' : 'Almarai',
                                    fontSize: w * 0.027,
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Center(child: Text(translateString('Choose delivery time', 'اختر وقت التوصيل'),style: TextStyle(color: Colors.black,fontSize: w*0.035,fontWeight: FontWeight.bold,),)),
                                                      SizedBox(height: h*0.02,),
                                                      Center(child: Text(translateString('Appointments available', 'المواعيد المتاحة'),style: TextStyle(color: mainColor,fontSize: w*0.035,fontWeight: FontWeight.normal,),)),
                                                      SizedBox(height: h*0.01,),
                                                      Padding(
                                                        ...
                                                        child: GridView.builder(
                                                          ...
                                                          itemBuilder: ( context, index) {
                                                            return Padding(
                                                              padding: EdgeInsets.symmetric(horizontal: 0.01*w,vertical: 0.01*h),
                                                              child: InkWell(
                                                                onTap: () async {
                                                                  setState(() {
                                                                    selected3 = index;
                                                                ...
                                                                child: Container(
                                                                  ...
                                                                  child: Padding(
                                                                    ...
                                                                    child: Row(
                                                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                                      children: [
                                                                        Text('${BlocProvider.of<AppCubit>(context).availableTimes!.data.deliveryTimes[index].beginTime}',style: TextStyle(color: Colors.black,fontSize: w*0.034,fontWeight: FontWeight.bold,),),
                                                                        const Icon(Icons.arrow_forward,color: Colors.grey,),
                                                                        Text('${BlocProvider.of<AppCubit>(context).availableTimes!.data.deliveryTimes[index].endTime}',style: TextStyle(color: Colors.black,fontSize: w*0.034,fontWeight: FontWeight.bold,),),
                                                                      ],
                                                                    ),
                                                                  ),
                                                                ),
                                                      ...
                                                      SizedBox(height: h*0.02,),
                                                      Center(child: Text(BlocProvider.of<AppCubit>(context).availableTimes!.data.note.note,style: TextStyle(color: mainColor,fontSize: w*0.035,fontWeight: FontWeight.normal,),)),
                                                      SizedBox(height: h*0.01,),
                                                    ],
                                                  ),
                                                ),
                                            ...
                                            Text(
                                              ...
                                              style: TextStyle(
                                                fontFamily: (lang == 'en')
                                                    ? 'Nunito'
                                                    : 'Almarai',
                                                color: mainColor,fontSize: w * 0.028,),
                                            ),
                                            const Icon(Icons.arrow_drop_down,color: Colors.grey,)
                                          ],
                                        ),
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                focusedErrorBorder: form2(),
                                hintText: _hint[11],
                                hintStyle: TextStyle(color: Colors.black,fontSize: w * 0.03,),
                              ),
                            ),
                          ],
                        ),
                          ...
                          builder: (context, state) {
                            return RoundedLoadingButton(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Text(
                                    translateString('Save address', 'حفظ العنوان'),
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontFamily:
                                        (lang == 'en') ? 'Nunito' : 'Almarai',
                  ...
                  SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(
                          child: Text(
                            translateString("Don't know the address? Add the recipient's number and we will receive it", 'لا تعرف العنوان ؟ أضف رقم هاتف المستلم ونوصّله بسهولة'),
                            style: TextStyle(
                                color: Colors.black,
                                fontFamily:
                                (lang == 'en') ? 'Nunito' : 'Almarai',
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hint: Row(
                              children: [
                                Text(translateString('Enter full name', 'ادخل الاسم بالكامل'),style: TextStyle(
                                    color: Colors.black,
                                    fontFamily:
                                    (lang == 'en') ? 'Nunito' : 'Almarai',
                                    fontSize: w * 0.027,
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hint: Row(
                              children: [
                                Text(translateString("+965 The recipient's Phone", '+965 رقم المستلم'),style: TextStyle(
                                    color: Colors.black,
                                    fontFamily:
                                    (lang == 'en') ? 'Nunito' : 'Almarai',
                                    fontSize: w * 0.027,
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hint: Row(
                              children: [
                                Text(translateString("+965 Your Phone Number", '+965 رقم هاتفك'),style: TextStyle(
                                    color: Colors.black,
                                    fontFamily:
                                    (lang == 'en') ? 'Nunito' : 'Almarai',
                                    fontSize: w * 0.027,
